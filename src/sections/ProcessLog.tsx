    ...
    items: [
      {
        ...
        content: "A critical turning point occurred on February 10, following a report in eNanyang regarding the signing of 11 bilateral MoCs between Malaysia and India."
      },
      {

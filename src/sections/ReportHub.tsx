...
import { ArrowRight, Globe, BarChart3, Map, Zap } from 'lucide-react';
      ...
      <main className="flex-grow max-w-7xl mx-auto px-8 py-20">
        ...
        <div className="text-center">
          <button
            ...
            className="px-8 py-3 bg-stone-200 hover:bg-stone-300 text-stone-700 rounded-full font-bold transition-colors"
          >
            Back to Home
          </button>
        </div>

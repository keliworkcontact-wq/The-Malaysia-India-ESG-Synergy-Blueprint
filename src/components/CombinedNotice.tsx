  ...
  return (
    <div className="max-w-4xl mx-auto border-t border-current/10 pt-8 mt-12 opacity-80">
      <p className={`text-[10px] md:text-xs ${textColor} leading-relaxed text-center italic`}>
        ...
        <strong>Disclaimer:</strong> This is an independent analytical proposal for professional demonstration and is not an officially commissioned document by HUL or governmental authorities. For commercial licensing or collaboration, please contact the author.
      </p>
    </div>
  );
}
